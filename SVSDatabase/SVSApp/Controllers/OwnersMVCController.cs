...
{
    public class OwnersMVCController : Controller
    {
        ...
        // GET: OwnersMVC/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: OwnersMVC/Create
